...
if (!function_exists('base_url')) { function base_url($p=''){ $b=rtrim($_SERVER['BASE_URL']??'/', '/'); return $b.'/'.ltrim($p,'/'); } }
...
$activeSlug = $activeSlug ?? ($company['slug'] ?? '');
$slug       = rawurlencode((string)$activeSlug);
...
<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
  ...
  <div class="rounded-2xl bg-white border p-4">
    ...
    <div class="text-3xl font-bold mb-3"><?= $ingredientsCount ?></div>
    <div class="flex gap-2">

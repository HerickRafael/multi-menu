...
<div class="max-w-3xl mx-auto p-4">
  ...
  <form method="post" action="<?= base_url('admin/' . e($slug) . '/orders') ?>" id="order-form" class="space-y-6">
    <!-- Dados do cliente -->
    ...
    <div class="flex gap-2">
      ...
      <a href="<?= base_url('admin/' . e($slug) . '/orders') ?>" class="px-4 py-2 rounded-xl border">Cancelar</a>
    </div>
  </form>
</div>
